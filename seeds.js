  ...
  .then(() =>
    Promise.all([
      ...
      Users.create({
        ...
        password:
          "$2b$10$JZ5ItMKfLxlFbTUu9d.bA.Evar83Esj7gXXKcJ5RJhto9Epgt9bQe", //bram
      }),
      Users.create({
        username: "MelEvans",
        password:
          "$2b$10$VtM.I0WO2LbDTbbAHvMavu6IL4AmoOyojXf6gjnjsSB3THQ8qYH2q", //mel
      }),
      Users.create({
        username: "AmberRodriguez",
        password:
          "$2b$10$Eu2AyBWuFSf.uYH3nj4yfePj8e.rHfGYWHRbOa5EBJgkvbK4lPQG2", //am
      }),
      Users.create({
        username: "ChrisLewis",
        password:
          "$2b$10$NSU6xf5Z3PyYW9lG4f6gAOx1jHuhi5KEt3gjygjgsxI1XE8r0aeaO", //c
      }),
      Users.create({
      ...
      Category.create({
        ...
        description:
          "Plants are a great way to make your house a better space to live in. You’ll find everything you need in and around your home to make it uniquely your own.",
        picture:
      ...
      Category.create({
        name: "Sporting Goods",
        description:
          "Are you ready to play like a pro? No matter what your favorite sport is, Marketplace has the equipment you need to perform at your peak.",
        picture:
      ...
      Products.create({
        ...
        price: 35,
        description:
          "Selling three great pillows because they are not compatible with the rest of the house anymore. It was styled by free by an tv-stylist, but we didn't like it so it all has to go.",
      ...
      Products.create({
        ...
        price: 850,
        description:
          "A silver iPhone X, I want to buy the newer version that came out last month. I've had this one for three months, so it's very new. It has been in the case since purchase, so it is practically unused.",
        color: "grey",
        userId: 3,
        categoryId: 2,
      }),
      Products.create({
        ...
        price: 250,
        description:
          "My son's Playstation VR Headset has to go. He barely has time for his family or his homework, we gave him an ultimatum and eventually he decided to keep living with us and to sell the headset",
        color: "white",
        userId: 2,
        categoryId: 2,
      }),
      Products.create({
        ...
        price: 1150,
        description:
          "I found out that this programming thing that everyone is talking about and doing bootcamps for,  is not my thing. All the debugging and learning, I don't understand why anyone would be able to do this. So, I'm selling my iMac.",
        color: "white",
        userId: 5,
        categoryId: 2,
      }),
      Products.create({
        ...
        price: 350,
        description:
          "There have been no new games for the Sony PSP that I liked. Actually, are they still made because I couldn't find any the last couple of years. It's still a great handheld to keep in your hand though, so it's a great purchase.",
        color: "black",
        userId: 4,
        categoryId: 2,
      }),
      Products.create({
        ...
        price: 250,
        description:
          "The Playstation 5 will be coming to the market in the end of year 2020, so I'm already selling all my Playstation 4 stuff (and FIFA20 as well, I hate all the rage quiting it makes me do) to prepare for the PS5 release.",
        color: "black",
        userId: 2,
        categoryId: 2,
      }),
      Products.create({
        ...
        price: 15,
        description:
          "These indoor succulents come with three plants, without any pots. They are only suitable for indoor life, but make up for this in cuteness.",
        color: "green",
        userId: 5,
        categoryId: 3,
      }),
      Products.create({
        ...
        price: 9.0,
        description:
          "A pot for small sized plants. It's the first one on the left. Has never been used, this purchase will be without the plant.",
        color: "orange",
        userId: 4,
        categoryId: 3,
      }),
      Products.create({
        ...
        price: 95,
        description:
          "These blue denim jeans come in different sizes and different colors. Check our website for more information and to see all the available jeans on offer and sale.",
        color: "blue",
        userId: 8,
        categoryId: 4,
      }),
      Products.create({
        ...
        price: 215,
        description:
          "These are limited edition Vans Sneakers, from line #359. They have never been on my feet, only took them out of the box for the photo. I got 30 pair of them (bought the whole line all in once), so I can offer them pretty cheap if you ask me.",
        color: "yellow",
        userId: 7,
        categoryId: 4,
      }),
      Products.create({
        ...
        price: 105,
        description:
          "This longboard was a bad Christmas gift, I have used it for two times now and it's really not my thing. Hopefully I can make someone else very happy with this.",
      ...
      Products.create({
        ...
        price: 15,
        description:
          "This Lea Este Libro Si Desea Tomar Buenas Fotografias Book is great. Keep it in your book case and never read it, or read it een though you don't know the language. Possibilities are endless.",
        color: "brown",
        userId: 7,
        categoryId: 6,
      }),
      ...
      Comments.create({
        comment:
          "Why do I have to put a comment at a product I haven't bought? This is me talking about pillows.",
        productId: 1,
        userId: 1,
      }),
      Comments.create({
        comment: "When do pillows look like this? Watch out with this buy...",
        productId: 1,
        userId: 2,
      }),
      Comments.create({
      ...
      Comments.create({
        comment:
          "I am very interested in this lamp, will you be able to take some off the price because I am going on holidays.",
        productId: 2,
        userId: 5,
      }),
      Comments.create({
        comment:
          "These pillows will look great on my red couch, I am definitely going to buy them from you.",
        productId: 1,
        userId: 2,
      }),
      Comments.create({
        comment:
          "I think programming is great, especially on an iMac from 2019. I am going to buy this!",
        productId: 5,
        userId: 3,
      }),
      Comments.create({
        comment:
          "It will take a while before the PS5 has enough games to be fun, so I'll stick to my PS4 for now and buy new controllers.",
        productId: 7,
        userId: 5,
      }),
      Comments.create({
      ...
      Comments.create({
        comment:
          "This succulent looks great, it will brighten up my house. I'm putting it in my cart as I type.",
        productId: 8,
        userId: 7,
      }),
      Comments.create({
